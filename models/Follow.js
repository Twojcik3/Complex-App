...
{
    //followed Username must be exist in DB
    ...
    let doesFollowAlreadyExist = await followsCollection.findOne({followeId: this.followedId, authorId: new ObjectID(this.authorId)})
    if(action == "create")
    {
