...
User.prototype.validate = function()
{
    return new Promise(async (resolve, reject)=>
    {
        ...
        if(this.data.username !="" && !validator.isAlphanumeric(this.data.username)){this.errors.push("This username can only contain letters and numbers")}
...
User.prototype.login = function()
{
    return new Promise((resolve, reject) =>
    {
        ...
        usersCollection.findOne({username: this.data.username}).then((attemptedUser)=>{
            ...
            {
                reject("incorrect passowrd or username")
            }
        }).catch(function(){
...
User.prototype.register = function()
{
    return new Promise(async (resolve, reject) =>
    {
        ...
        //step #2 only if there are no validation error, then save the user data in db
